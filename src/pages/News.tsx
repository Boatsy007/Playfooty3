...
function NewsEmptyState() { return <section className="sports-empty"><h2>No published articles yet</h2><p>Country netball news will appear here once articles are published.</p></section> }
