...
export default function Directory() {
  ...
  useSeo({
    ...
    description: 'Search Australia’s community football clubs and teams by name, state and league, or browse A–Z. A PlayFooty prototype club directory for community football.',
    path: '/directory',
  })
...
function ChampionshipTeaser() { return <Link to="/championship" className="side-card championship"><CalendarDays /><span>Future showcase pathway</span><strong>Club form can power future pathways</strong><small>Coming soon</small></Link> }
...
function ClubsStyles() { return <style>{`
  ...
  @media (max-width:720px){.clubs-page{padding:14px 12px 38px}.clubs-header{padding:18px;border-radius:16px}.header-copy h1{font-size:3.5rem}.header-copy p{font-size:15px}.featured-strip{grid-template-columns:1fr}.feature-tile{min-height:116px}.club-grid{grid-template-columns:1fr;padding:12px}.clubs-sidebar{display:flex}.clubs-sidebar .side-card{width:100%}.directory-toolbar a{display:none}.filters-panel{grid-template-columns:1fr}.club-card{padding:15px;min-height:230px}.club-card h2,.feature-tile strong{white-space:normal;overflow-wrap:anywhere}.header-stats b{font-size:11px}}
`}</style> }
