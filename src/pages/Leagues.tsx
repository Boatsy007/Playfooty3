...
function LeaguesStyles() { return <style>{`
  ...
  @media (max-width:720px){.leagues-page{padding:14px 12px 38px}.leagues-header{padding:18px;border-radius:16px}.header-copy h1{font-size:3.5rem}.header-copy p{font-size:15px}.featured-strip{grid-template-columns:1fr}.league-grid{grid-template-columns:1fr;padding:12px}.leagues-sidebar{display:flex}.directory-toolbar a{display:none}.filters-panel{grid-template-columns:1fr}.league-card{padding:15px}}
`}</style> }
