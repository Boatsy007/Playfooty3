        ...
        {!loading && !error && (
          <>
            ...
            <div className="leagues-layout">
              <section className="league-directory" aria-label="Country football league directory">
...
function ManualLeagueCard() { return <article className="side-card manual-card"><span>Manual league ready</span><strong>Add league data through admin when available</strong><small>Fixtures, results and ladders can be imported or managed when real competition data is available.</small></article> }
function ChampionshipTeaser() { return <Link to="/championship" className="side-card championship"><CalendarDays /><span>Future PlayFooty Championship</span><strong>Future showcase, not a live event</strong><small>Coming soon</small></Link> }
