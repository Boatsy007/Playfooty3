...
export const CATEGORIES: Category[] = [
  { id: 'rankings',        label: 'Rankings',        accent: '#d71920', blurb: 'Every movement on the national leaderboard.' },
  { id: 'championship',    label: 'Championship',    accent: '#f4c14d', blurb: 'Future showcase coverage.' },
  { id: 'club-news',       label: 'Club News',       accent: '#d71920', blurb: 'From the clubrooms up.' },
  ...
  { id: 'transfers',       label: 'Transfers',       accent: '#d71920', blurb: 'Ins, outs and signings.' },
...
export const ARTICLES: Article[] = [
  A({
    ...
    tags: { state: 'VIC', league: 'Bellarine FNL - Senior Football', club: 'Geelong Amateur' },
    body: [
      ...
      { type: 'quote', text: 'We don’t talk about rankings inside the group — but the standard we hold ourselves to is exactly what put us here.', cite: 'Geelong Amateur Senior coach' },
    ...
    gallery: [{ seed: 'ga-1', caption: 'A stoppage under lights.' }, { seed: 'ga-2', caption: 'The team huddle.' }],
  }),
  A({
    slug: 'wildcard-invitations-announced',
    title: 'Future showcase pathway: how invitations could work',
    subtitle: 'Future concepts only: no invitation process is currently open.',
    category: 'championship', author: { name: 'Dan Whitely', role: 'Showcase Reporter' },
    date: '2026-07-01', readingTime: 4, featured: true, trending: true, breaking: true,
    heroSeed: 'wildcard', summary: 'How a future invitation pathway could work once a real showcase model is announced.',
    tags: { state: 'National' },
    body: [
      { type: 'p', text: 'No clubs are currently qualified for a PlayFooty event. This draft explains how a future invitation pathway could be communicated transparently.' },
      { type: 'quote', text: 'A pathway only works when clubs understand the criteria.', cite: 'PlayFooty editorial note' },
      { type: 'p', text: 'Any real pathway would be published before clubs are asked to make decisions.' },
    ],
  }),
  A({
    slug: 'future-showcase-format-explained',
    title: 'Future showcase format explained',
    subtitle: 'A future event concept only — no dates, venues or teams are live.',
    category: 'championship', author: { name: 'Dan Whitely', role: 'Showcase Reporter' },
    date: '2026-06-30', readingTime: 3, trending: true, breaking: true,
    heroSeed: 'schedule', summary: 'A concept explainer for how a future national community football showcase could be structured.',
    tags: { state: 'National' },
    body: [
      { type: 'p', text: 'No PlayFooty championship schedule is live. This reference draft shows how future event information would be presented once confirmed.' },
      { type: 'p', text: 'PlayFooty will not publish fixtures, teams or venues until real data exists.' },
    ],
  }),
  A({
  ...
  A({
    slug: 'drouin-adds-marquee-recruit',
    title: 'Transfer: Drouin add marquee recruit',
    ...
    heroSeed: 'drouin-signing', summary: 'Drouin have secured one of the most sought-after recruits in the region ahead of a major local footy push.',
    tags: { state: 'VIC', league: 'Gippsland League - Senior Football', club: 'Drouin' },
    body: [
      { type: 'p', text: 'Drouin have moved early and decisively, adding a marquee recruit who instantly lifts their ceiling.' },
      { type: 'quote', text: 'The pull of a big season is real. This group is going somewhere.', cite: 'The incoming recruit' },
    ],
  }),
  A({
    slug: 'player-spotlight-goal-machine',
    title: 'Player Spotlight: the forward rewriting the record books',
    ...
    heroSeed: 'spotlight-forward', summary: 'Accuracy, volume and nerve — a deep dive on the forward putting up numbers community football has rarely seen.',
    tags: { state: 'VIC', league: 'Geelong & District FNL - Senior Football' },
    body: [
      { type: 'p', text: 'Some seasons demand a closer look. This is one of them.' },
      { type: 'quote', text: 'I just try to make the next one. That’s the whole game, really.', cite: 'The featured forward' },
  ...
  A({
    ...
    tags: { state: 'VIC', league: 'Geelong FNL - Senior Football' },
    body: [
  ...
  A({
    ...
    heroSeed: 'gippsland-race', summary: 'The Gippsland League Senior race is the tightest it has been in years, with national implications.',
    tags: { state: 'VIC', league: 'Gippsland League - Senior Football', club: 'Moe' },
    body: [
  ...
  A({
    ...
    heroSeed: 'grassroots', summary: 'From AusKick to Senior, a wave of junior participation is rewriting the future of community football.',
    tags: { state: 'National' },
    body: [
